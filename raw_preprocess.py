...
reg_special = re.compile('[^A-Za-z0-9]+') #문자,숫자 제외한 나머지
reg_num = re.compile('[0-9]+') #숫자
...
save_path = "//media/hs-ubuntu/data/dataset/STMD_data/"

raw_data = data_path + "reviews_Electronics.json.gz"
meta_data = data_path + "meta_Electronics.json.gz"
